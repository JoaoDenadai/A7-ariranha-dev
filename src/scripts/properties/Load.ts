...
const developerMode:HTMLInputElement = document.getElementById('enable-developer-mode') as HTMLInputElement;
...
developerMode.addEventListener('change', function():void
{
