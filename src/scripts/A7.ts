...
import { Loaded_Settings, atualizar_o_JSON_main } from "./JSON_Load.js";
...
//Carregando configurações do JSON.
A7_Input.value = Loaded_Settings.preferences.a7Value;
A7_AutomaticFormat_Checkbox.checked = Loaded_Settings.preferences.a7AutoFormat;
...
A7_AutomaticFormat_Checkbox.addEventListener('change', function(event):void
{
    ...
    //Atualizando o JSON.
    //Aqui nós atualizamos o objeto de JSON e atualizamos o arquivo, salvando as informações.
    Loaded_Settings.preferences.a7Value = A7_Input.value;
    Loaded_Settings.preferences.a7AutoFormat = A7_AutomaticFormat_Checkbox.checked;
    ...
    if(A7_AutomaticFormat_Checkbox.checked || isEnabledA7_AutomaticFormat_Bypass)
    {
        ...
        else
        {
            ...
            if(A7_Input.value.length === 9)
            {
                ...
                //Atualizamos o arquivo JSON, atualizando primeiro o valor da variável.
                Loaded_Settings.preferences.a7Value = A7_Input.value;
                atualizar_o_JSON_main(Loaded_Settings);
            }
        }
...
function removeFormatationFromA7():string
{
    ...
    A7_Input.value = removeFormatationFromA7Temp

    //Atualizanos o objeto JSON e passamos para o arquivo JSON.
    Loaded_Settings.preferences.a7Value = A7_Input.value;
    atualizar_o_JSON_main(Loaded_Settings);
    //Retorna o código A7.
    return A7_Input.value;
}
